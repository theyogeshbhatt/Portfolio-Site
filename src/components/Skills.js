...
const Skills = () => {
  return (
    ...
    '>
      ...
      <Skill name="Bootstrap" x="0vw" y="11vw" />
      <Skill name="ReactJS" x="-20vw" y="-15vw" />
      <Skill name="NextJS" x="15vw" y="-12vw" />
      <Skill name="NodeJS" x="30vw" y="-5vw" />
      <Skill name="MongoDB" x="0vw" y="-19vw" />
      <Skill name="Web Design" x="-20vw" y="18vw" />
      <Skill name="Tailwind CSS" x="12vw" y="18vw" />
      <Skill name="Figma" x="-30vw" y="6vw" />
    </div>
    </>
  )
}
