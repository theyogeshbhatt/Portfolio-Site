        ...
        bg-dark/90 dark:bg-light/75 rounded-lg backdrop-blur-md py-32'>
           <nav className="flex items-center flex-col justify-center">
            ...
            <nav className="flex items-center justify-center flex-wrap mt-2">
                ...
                <motion.a href="https://www.github.com" target={"_blank"} 
                whileHover={{y:-2}} whileTap={{scale:0.9}} className="w-6 mx-3 sm:mx-1 bg-light rounded-full dark:bg-dark ">
                    <GithubIcon />
                </motion.a>
                <motion.a href="https://www.linkedin.com" target={"_blank"} 
                ...
                <motion.a href="https://www.pinterest.com" target={"_blank"} 
                whileHover={{y:-2}} whileTap={{scale:0.9}} className="w-6 mx-3 sm:mx-1 bg-light rounded-full ">
                    <PinterestIcon />
                </motion.a>
                <motion.a href="https://www.dribble.com" target={"_blank"} 
