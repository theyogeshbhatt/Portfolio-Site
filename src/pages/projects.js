...
import project1 from "../../public/images/projects/medico-image.png"
...
const projects = () => {
  return (
    <>
    <Head>
        <title>YogeshBhatt | Projects Page</title>
    ...
    <main className='w-full mb-16 flex flex-col items-center justify-center dark:text-light'>
        ...
        <div className='grid grid-cols-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0'>
            <div className='col-span-12'>
                ...
                title="Medico"
                img={project1}
                summary="An end to end portal for patient registration, organizing information and fixing appointments 
                with healthcare professionals - HTML, CSS, JavaScript, jQuery, Bootstrap, SASS. "
                link="/"
                github="/"
