...
export default function Home() {
  return (
    <>
      <Head>
        <title>YogeshBhatt | Home Page</title>
        ...
        <Layout className='pt-0 md:pt-16 sm:pt-8'>
          <div className='flex items-center justify-between w-full lg:flex-col'>
            <div className='w-1/2 md:w-full'>
              <Image src={profilePic} alt="YogeshBhatt" 
              className='w-full h-auto lg:hidden md:inline-block md:w-full' 
              priority 
              sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 50vw" />
            </div>

            <div className='w-1/2 flex flex-col items-center self-center lg:w-full  lg:text-cemter'>
...
Explore my latest projects and articles, showcasing my expertise in React.js and web development.
              ...
              <div className='flex items-center self-start mt-2 lg:self-center'>
                ...
                <Link href="mailto:yogeshbhattofficial@gmail.com" target={'_blank'}
        ...
        <div className='absolute right-8 bottom-8 inline-block w-24 md:hidden'>
          <Image src={lightBulb} alt="YogeshBhatt" className='w-full h-auto' />
        </div>
      </main>
    </>
  )
